...
export declare const ERROR_CODES: {
    ...
    readonly MISSING_POSTING_KEY: "MISSING_POSTING_KEY";
    readonly INVALID_PRIVATE_KEY: "INVALID_PRIVATE_KEY";
    readonly INVALID_USERNAME: "INVALID_USERNAME";
    readonly INVALID_PERMLINK: "INVALID_PERMLINK";
    readonly INVALID_TAGS: "INVALID_TAGS";
    readonly MISSING_TITLE: "MISSING_TITLE";
    readonly MISSING_BODY: "MISSING_BODY";
    readonly INVALID_VOTE_WEIGHT: "INVALID_VOTE_WEIGHT";
    readonly NETWORK_ERROR: "NETWORK_ERROR";
    readonly NODE_UNAVAILABLE: "NODE_UNAVAILABLE";
    readonly TIMEOUT_ERROR: "TIMEOUT_ERROR";
    readonly ALL_NODES_FAILED: "ALL_NODES_FAILED";
    readonly TRANSACTION_FAILED: "TRANSACTION_FAILED";
    readonly INSUFFICIENT_RC: "INSUFFICIENT_RC";
